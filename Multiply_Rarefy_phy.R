...
## This can be run in the command line with a phyloseq object:
## Rscript Multiply_Rarefy_phy.R phyloseq_obj.rds 10000 rare_phy_obj.rds

## Must provide input phyloseq and rarefying depth. There is an automatic naming of final phyloseqs if left unnamed.


## Redeveloping for Phyloseq Objects
#################################
